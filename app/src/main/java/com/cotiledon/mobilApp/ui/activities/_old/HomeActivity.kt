...
/*class HomeActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val productosCarrusel1 = arrayOf(
            R.id.product1_carouselView,
            R.id.product2_carouselView,
            R.id.product3_carouselView,
            R.id.product4_carouselView,
            R.id.product5_carouselView,
            R.id.product6_carouselView
        )
        val imagenesCarrusel1 = arrayOf(
